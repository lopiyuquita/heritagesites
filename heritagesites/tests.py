...
#The setUp() method is broken. See in particular HeritageSite.objects.create() method.
#It is missing several required properties. Restore the missing properties and values.
