...
#list_display is what I am going to see in my admin page under country_area
	list_display = [
		'country_area_name',
		#'region',
		#'sub_region',
		...
		'iso_alpha3_code',
		'm49_code',
		#'location', #added to reflect on the new model(table), Location.
		'dev_status'
	]
...
class LocationAdmin(admin.ModelAdmin):
	...
	New class added as a result of Mtg 5 database refactoring.
	"""
    ### fields is what would be displayed/shown in the admin site of add/update location
